...
ReadTxtFile::ReadTxtFile() :fullIntro(0), introTimer(0), sequence(0), bgTimer(0), TimerStart(false), timerTime(false), timerReset(false), flashON(false), asylumON(false), intro_dialogue(nullptr), city(nullptr), flash(nullptr), asylum(false)
{
